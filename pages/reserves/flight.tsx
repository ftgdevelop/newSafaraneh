...
import { shabGetReservedFlights } from '@/modules/shab/actions';
...
const ShabFlightReserveList: NextPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchList = async (id: string) => {
            setLoading(true);
            const response: any = await shabGetReservedFlights({ 
                TrackerId: id ,
                MaxResultCount: "50",
                SkipCount:"0"
            });
...
export default ShabFlightReserveList;