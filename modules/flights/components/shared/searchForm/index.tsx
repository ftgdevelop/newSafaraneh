...
import { Calendar, CalendarFill, Loading, Location, SearchTheme3, Swap, Travel } from '@/modules/shared/components/ui/icons';
...
type InnerProps = {
  ...
  buttonInnerHtml: React.ReactNode;
  props: any;
  locations: any;
    setLocations: any;
    renderOption: any;
...
const SearchFormInner: React.FC<InnerProps> = ({
    theme1,
    theme2,
    theme3,
    isFa,
    ...
    const {
        ...
        isValid,
        isSubmitting,
    } = useFormikContext<FlightSeachFormValue>();
                    ...
                    const renderFlightDates = () => <>
                                    <div className={`${theme3 ? "md:col-span-3" : theme2 ? "sm:col-span-2 lg:col-span-1 xl:col-span-2" : ""}`} >
                                         <DatePicker2<DomesticFlightInputProps>
                                            ...
                                            isFa={isFa}
                                            setIsFa={setIsFa}
                                            onChange={(v)=>setFieldValue('departureDate', v)}
                                            Input={DomesticFlightDatePickerInput}
                                            value={values.departureDate ?? ""}
                                            inputProps={{
                                                isTouched:touched.departureDate,
                                        ...
                                        values.airTripType === 'RoundTrip' ? (
                                            <div className={`${theme3 ? "md:col-span-3" : theme2 ? "sm:col-span-2 lg:col-span-1 xl:col-span-2" : ""}`} >
                                                <DatePicker2<DomesticFlightInputProps>
                                                    ...
                                                    inputProps={
                                                        {
                                                            isTouched:touched.returnDate,
                                                            errors: errors.returnDate,
                                                            label: 'تاریخ برگشت',
                                                            isDisabled: values.airTripType === "RoundTrip",
                                                            isEnd: true
                                                        }
                                                    }
                                            ...
                                            <AutoCompleteZoom
                                                ...
                                                onChangeHandle={
                                                    ...
                                                    (v: AirportAutoCompleteType | undefined) => {
                                                        ...
                                                        (
                                                            prevState: [
                                                            AirportAutoCompleteType | undefined,
                                                            AirportAutoCompleteType | undefined
                                                            ]
                                                        ) => [
                                                            v,
