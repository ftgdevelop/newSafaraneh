                ...
                <div>
                    ...
                    <div className="px-4 flex gap-2 items-center text-xs mb-2">
                        ...
                        <span className="text-neutal-500 font-sans" dir="ltr">
                            ({dateDisplayFormat({ date: departureFlight.departureTime, format: "dd mm", locale: "en" })})
                        </span>
                    ...
                    <div className="px-4 gap-3 flex justify-between items-center leading-6 mb-4">
                        ...
                        <div className="text-sm">
                            ...
                            {departureFlight.arrivalTime ? dateDisplayFormat({ date: departureFlight.arrivalTime, format: "HH:mm", locale: 'fa' }) : "--"}
                        </div>
                    ...
                    {!!returnFlight && (
                        <>
                            <div className="px-4 flex gap-2 items-center text-xs mb-2 mt-4">
                                ...
                                <span className="text-neutal-500 font-sans" dir="ltr">
                                    ({dateDisplayFormat({ date: returnFlight.departureTime, format: "dd mm", locale: "en" })})
                                </span>
                            ...
                            <div className="px-4 gap-3 flex justify-between items-center leading-6 mb-4">
                                ...
                                <div className="text-sm">
                                    ...
                                    {returnFlight.arrivalTime ? dateDisplayFormat({ date: returnFlight.arrivalTime, format: "HH:mm", locale: 'fa' }) : "--"}
                                </div>
