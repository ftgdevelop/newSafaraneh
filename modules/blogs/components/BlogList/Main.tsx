...
const Main: NextPage<any> = () => {
    const Blogs: BlogItemType[] = useContext(AllData)[0]
    const LastBlogs: BlogItemType[] = useContext(AllData)[1]
    const CategoriesName: CategoriesNameType[] = useContext(AllData)[2]
    console.log(Blogs);
